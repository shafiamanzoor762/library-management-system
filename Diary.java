...
public class Diary
{
   ...
   {
      Date date = itemReservation.getSDate();
      for(int day=1; day<=itemReservation.getNDays(); day++)
      {
      ...
      private void printEntries()
      {
         ...
         if( size>0 )
         {
            ...
            for( Entry entry: daysEntries )
            {
               ...
               int reservationDay = DateUtil.daysBetween(itemReservation.getSDate(), date) + 1;;
               System.out.println("    " + itemReservation + ", day " + reservationDay + " of " + itemReservation.getNDays());
            }
         }
         else
         {
